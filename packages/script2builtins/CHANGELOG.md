...
- Companion package [`script2builtins-runtime`](https://github.com/StackedQueries/script2builtins-runtime) provides the dynamic-analysis layer with the same report shape.
