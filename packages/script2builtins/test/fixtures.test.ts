/**
 * Synthetic-fixture end-to-end tests.
 *
 * Real captured detector blobs require external fetch + legal review;
 * as an interim, this file exercises the full pipeline — `analyze()`
 * → verdict line → summary fields → renderText output — against
 * hand-rolled synthetic fixtures that mimic the canonical shape of
 * each vendor's blob:
 *
