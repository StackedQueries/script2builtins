...
(See the runtime package's [recipes](https://github.com/StackedQueries/script2builtins/blob/main/packages/script2builtins-runtime/docs/recipes.md).)
...
The shape is the `Report` from [`src/types.ts`](https://github.com/StackedQueries/script2builtins/blob/main/packages/script2builtins/src/types.ts).
