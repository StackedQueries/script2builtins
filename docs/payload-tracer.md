...
[`src/analyze/values.ts`](https://github.com/yourorg/script2builtins/blob/main/src/analyze/values.ts)
...
[`parseRuntimeBody`](https://github.com/yourorg/script2builtins/blob/main/src/analyze/sinks.ts)
